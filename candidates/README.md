...
on real prose, and some will turn out to be noisy or wrong. `consultant` is the
...
| [`consultant`](consultant.json) | 24 | A consultant's house writing standard. Unlike the rest of this directory it *is* evaluated on real prose: every threshold is set from 88 documents and 431,000 words of McKinsey, BCG and Bain writing. Built by `tools/build-consultant.mjs`. |
