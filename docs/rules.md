...
| `pr-vocabulary` | 1 | The same idea derived here instead of taken from elsewhere, rebuilt every morning from GitHub pull requests. See [vocabulary.md](vocabulary.md). |
